...
<div class="label">${uiLabelMap.ProductFindProductWithIdValue}:</div>
  ...
  <div class="label" style="margin-left: 324px; margin-top: -12px;">${"Create a new Main Category"}:</div>
  <form method="post" action="<@ofbizUrl>EditProdCatalog</@ofbizUrl>" style="margin: 0;" name="EditProdCatalogForm">
    ...
    <input type="submit" value=" ${uiLabelMap.ProductEditCatalog}" class="smallSubmit"/>${" OR  : "}
