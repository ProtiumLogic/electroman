            ...
            <fo:table>
                ...
                <fo:table-header>
                    <fo:table-row font-weight="bold">
                        ...
                        <fo:table-cell border-bottom="thin solid grey"><fo:block>${"Store Name"}</fo:block></fo:table-cell>
                        <fo:table-cell border-bottom="thin solid grey"><fo:block>${"Qty Availiable"}</fo:block></fo:table-cell>
                    ...
                    <#list productReportList as productReport>
                      <#if productReport.quantityOrdered?exists && (productReport.quantityOrdered > 0)>
                        <fo:table-row>
                            ...
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>${productReport.storeName}</fo:block>
                            </fo:table-cell>
			    <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>${productReport.quantityOnHandTotal}</fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
