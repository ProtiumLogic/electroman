	           ...
	           <fo:table-column column-width="60px"/>
                ...
                <fo:table-header>
                    ...
                    <fo:table-cell border-bottom="thin solid grey"><fo:block>${"Product ID"}</fo:block></fo:table-cell>
                        ...
                        <fo:table-cell border-bottom="thin solid grey"><fo:block>${"Curr RSP"}</fo:block></fo:table-cell>
                        <fo:table-cell border-bottom="thin solid grey"><fo:block>${"New RSP"}</fo:block></fo:table-cell>
		        ...
		        <#list supplierProducts as item>
						...
						<#assign PreCostVal = item.getBigDecimal("lastPrice").multiply(QOHTotal)/>
						<#assign RevCostVal = item.getBigDecimal("updatedLastPrice").multiply(QOHTotal)/>
