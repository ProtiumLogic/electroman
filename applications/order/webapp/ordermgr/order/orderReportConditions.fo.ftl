...
<#--
<fo:block space-after="150pt"/>
-->


<fo:block  border-width="thin" border-color="black" padding-top="3px" width="100%">
...
<fo:table-body>
  <fo:table-row>
    <fo:table-cell>
      <fo:block font-family="Times New Roman"   text-align="center" font-size="10px">Prepared By</fo:block>
    </fo:table-cell>
    <fo:table-cell>
      <fo:block> </fo:block>
    </fo:table-cell>
    <fo:table-cell>
      <fo:block font-family="Times New Roman" text-align="right"  font-size="10px">Approved By</fo:block>
    </fo:table-cell>
  </fo:table-row>
</fo:table-body>
...
<fo:table-body>
  <fo:table-row>
    <fo:table-cell>
      <fo:block font-family="Times New Roman" font-size="10px">Prepared By</fo:block>
    </fo:table-cell>
    <fo:table-cell>
      <fo:block> </fo:block>
    </fo:table-cell>
    <fo:table-cell>
      <fo:block font-family="Times New Roman" font-size="10px">Approved By</fo:block>
    </fo:table-cell>
  </fo:table-row>
</fo:table-body>
