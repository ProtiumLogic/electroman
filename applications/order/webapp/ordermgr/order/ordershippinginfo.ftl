            ...
            <td valign="top" width="80%">
                <#list shipGroupShipments as shipment>
                    <div>
                      ...
                      <#assign shippingreceipt = delegator.findByAnd("ShipmentReceipt", Static["org.ofbiz.base.util.UtilMisc"].toMap("shipmentId",shipment.shipmentId))?if_exists>
                      <#if shippingreceipt?has_content>
                      <a target="_BLANK" href="/facility/control/ShipmentReceipt.pdf?shipmentId=${shipment.shipmentId}&amp;externalLoginKey=${externalLoginKey}" class="buttontext">GRN</a>
                      </#if>
