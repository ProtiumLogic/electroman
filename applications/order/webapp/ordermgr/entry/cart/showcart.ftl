        ...
        <#if parameters.availabalityList?has_content>
          <table>
            ...
            <#list parameters.availabalityList as availabality>
             	<#assign facilityInfo = delegator.findOne("Facility", Static["org.ofbiz.base.util.UtilMisc"].toMap("facilityId",availabality.facilityId), false)>
            
               <tr>
                 <td>${facilityInfo.facilityName?if_exists}</td>
