        ...
        <form name="returnItems" method="post" action="<@ofbizUrl>returnItems</@ofbizUrl>">
          ...
          <table border='0' cellpadding='2' cellspacing='0'>
            ...
            <#if partyOrders?has_content>
              <tr>
                <td width='25%' align='right' nowrap="nowrap" class="label">Invoice Id</td>
                <td>&nbsp;</td>
                <td width='25%'>
                  <select name="orderId">
                ...
                <td><div class="tooltip">Load Invoice Items for Return</div></td>
              </tr>
            <#else>
              <tr>
                <td colspan="4" nowrap="nowrap"><div>No Invoice Found For Party: <a href="${customerDetailLink}${partyId?default('_NA_')}" class="buttontext">${partyId?default('[null]')}</a></div></td>
              </tr>
              <tr>
                <td width='25%' align='right' nowrap="nowrap"><div>Invoice Id</div></td>
                <td>&nbsp;</td>
                <td width='25%'>
            ...
            <tr>
              <td colspan="2">&nbsp;</td>
              <td colspan="2">
                <a href="javascript:document.returnItems.submit();" class="buttontext">Load Invoice Items for Return</a>
              </td>
            </tr>
          </table>
        </form>
