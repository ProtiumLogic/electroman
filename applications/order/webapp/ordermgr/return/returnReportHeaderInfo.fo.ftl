...
<fo:table-row>
	 ...
	 <fo:table-cell display-align="left" padding-left="-35px">
	 	<fo:block font-size="10px" font-family="Times New Roman">${returnHeader.returnId}</fo:block>
	 </fo:table-cell>
	 <fo:table-cell display-align="right" padding-left="40px">
	 	<fo:block font-size="10px" font-family="Times New Roman">${returnDate?if_exists}</fo:block>
	 </fo:table-cell>
	  <fo:table-cell colspan="3"><fo:block/></fo:table-cell>
	 <fo:table-cell display-align="right" padding-left="60px">
	 	<fo:block font-size="10px" font-family="Times New Roman">${returnHeader.returnId}</fo:block>
	 </fo:table-cell>
	 <fo:table-cell display-align="right" padding-left="40px">
	 	<fo:block font-size="10px" font-family="Times New Roman" text-align="right" >${returnDate?if_exists}</fo:block>
	 </fo:table-cell>
</fo:table-row>
...
<fo:table-row>
 <fo:table-cell><fo:block/></fo:table-cell>
  <fo:table-cell display-align="left" padding-left="-25px"><fo:block font-size="10px" font-family="Times New Roman"><#if returnHeader.fromPartyId?has_content>${Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, returnHeader.fromPartyId, false)?if_exists}</#if>
</fo:block></fo:table-cell>
 <fo:table-cell colspan="3"><fo:block/></fo:table-cell>
 
 <fo:table-cell><fo:block/></fo:table-cell>
  <fo:table-cell display-align="right" padding-left="140px"><fo:block font-size="10px" font-family="Times New Roman"><#if returnHeader.fromPartyId?has_content>${Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, returnHeader.fromPartyId, false)?if_exists}</#if>
</fo:block></fo:table-cell>
 </fo:table-row>
 ...
 <fo:table-row>
 <fo:table-cell><fo:block/></fo:table-cell>
 <fo:table-cell padding-left="-33px"><fo:block font-size="10px"  font-family="Times New Roman">${telecomNumber.contactNumber? if_exists}</fo:block></fo:table-cell>
 <fo:table-cell colspan="3"><fo:block/></fo:table-cell>
 
 <fo:table-cell><fo:block/></fo:table-cell>
 <fo:table-cell padding-left="40px"><fo:block font-size="10px" font-family="Times New Roman">${telecomNumber.contactNumber? if_exists}</fo:block></fo:table-cell>
 </fo:table-row>
