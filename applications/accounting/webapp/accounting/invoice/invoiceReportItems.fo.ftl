    ...
    <fo:table-body  font-size="10pt" >
        ...
        <#list invoiceItems as invoiceItem>
            ...
            <#if itemBillings?has_content>
                ...
                <#assign orderItemRes = delegator.findByPrimaryKey("OrderReservationSummary", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId",itemBilling.orderId,"orderItemSeqId",invoiceItem.invoiceItemSeqId))>
...
<#assign productInfo = delegator.findOne("Product", Static["org.ofbiz.base.util.UtilMisc"].toMap("productId",invoiceItem.productId ), true)>
<#if productInfo.productTypeId=="MARKETING_PKG_AUTO">
<#assign bundleProductList = delegator.findByAnd("ProductAssoc", Static["org.ofbiz.base.util.UtilMisc"].toMap("productId",invoiceItem.productId,"productAssocTypeId","MANUF_COMPONENT" ))>
                ...
                <fo:table-row height="14px" >
					...
					<#else>
                      ...
                      <fo:table-cell padding-left="15px" padding-top="3px">
                        <fo:block font-size="10px" font-family="Times New Roman"> <#if invoiceItem.quantity?exists> ${invoiceItem.amount.setScale(decimals, rounding).toString()}</#if> </fo:block>
                    </fo:table-cell>
					<fo:table-cell padding-top="3px" padding-left="35px" text-align="center">
						<fo:block  font-size="10px" font-family="Times New Roman"> <#if invoiceItem.quantity?exists>${invoiceItem.quantity?string.number}</#if> </fo:block>
                    </fo:table-cell> 
					<#-- New Loc -->
					<fo:table-cell padding-top="3px" padding-left="35px" text-align="center">
                    ...
                    <fo:table-cell text-align="right" padding-left="45px" padding-top="3px">
                        <fo:block font-size="10px" font-family="Times New Roman">${Static["org.ofbiz.accounting.invoice.InvoiceWorker"].getInvoiceItemTotal(invoiceItem).setScale(decimals, rounding).toString()?if_exists} </fo:block>
                    </fo:table-cell>
	...
	<fo:table-cell><fo:block/></fo:table-cell>
			...
			<fo:table-cell  padding-top="3px" padding-left="40px">
					...
					<fo:table-cell padding-top="3px" padding-left="25px" text-align="center">
                        <fo:block  font-size="10px" font-family="Times New Roman"> <#if invoiceItem.quantity?exists>${invoiceItem.quantity?string.number}</#if>
					</fo:block> 
                    </fo:table-cell> 
                    ...
                    <fo:table-cell padding-top="3px"  padding-left="65px">
                        <fo:block font-size="10px" font-family="Times New Roman">
							${Static["org.ofbiz.accounting.invoice.InvoiceWorker"].getInvoiceItemTotal(invoiceItem).setScale(decimals, rounding).toString()?if_exists}
						</fo:block>
                    </fo:table-cell>
...
<#--   tax not in oman - sam
                ...
                <fo:table-row height="14px" space-start=".15in">
                    <fo:table-cell number-columns-spanned="2">
                        <fo:block text-align="right" font-size="10px" font-family="Times New Roman">${description?if_exists}</fo:block>
                    </fo:table-cell>
...
<#--
        <fo:table-row height="14px">
           ...
           <fo:table-cell text-align="right" border-top-style="solid" border-top-width="thin" border-top-color="black">
              <fo:block>
                 ${invoiceNoTaxTotal.setScale(decimals, rounding).toString()}
              </fo:block>
           </fo:table-cell>
        </fo:table-row>
-->
	  ...
	  <fo:table-body>
        ...
        <fo:table-row>
           <fo:table-cell padding-left="70px" border-width="thin" border-color="black">
             <fo:block font-size="8px" text-align="left" font-family="Times New Roman">${invoiceTotalInWords}</fo:block>
           </fo:table-cell>
           <fo:table-cell padding-left="120px" border-width="thin" border-color="black">
              <fo:block font-size="8px" text-align="left" font-family="Times New Roman">${invoiceTotal.setScale(decimals, rounding).toString()}</fo:block>
           </fo:table-cell>

           <fo:table-cell padding-left="190px"  border-width="thin" border-color="black">
            <fo:block font-size="8px" text-align="left" font-family="Times New Roman">${invoiceTotalInWords}
			 </fo:block>
           </fo:table-cell>
		   <fo:table-cell  border-width="thin" border-color="black"  padding-left="160px">
              <fo:block font-size="8px"  font-family="Times New Roman">${invoiceTotal.setScale(decimals, rounding).toString()}</fo:block>
           </fo:table-cell>
        </fo:table-row>
        ...
        <fo:table-row>
           <fo:table-cell border-width="thin" border-color="black" number-columns-spanned="2" padding-right="120.4px">
			...
			<fo:block font-size="8px" text-align="right" font-family="Times New Roman">${Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, cashierId, false)?if_exists}
			 </fo:block>	      
	       </fo:table-cell>
