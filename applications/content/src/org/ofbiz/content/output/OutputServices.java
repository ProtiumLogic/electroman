...
public class OutputServices {
    ...
    public static Map<String, Object> createFileFromScreen(DispatchContext dctx, Map<String, ? extends Object> serviceContext) {
		...
		//	paper.setSize(612, 900);
		//	paper.setImageableArea(0, 0, 612, 800);
			paper.setSize(594.992125984252, 850.8897637795276);
			paper.setImageableArea(36.0, 36.0, 522.99212598425197, 769.8897637795276);
			pf.setPaper(paper); 
