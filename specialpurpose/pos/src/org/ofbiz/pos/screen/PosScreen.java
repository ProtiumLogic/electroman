...
public class PosScreen extends XPage implements Runnable, DialogCallback, FocusListener {
    ...
    protected FacilityInput facilityInput = null;
    protected QuoteInput qinput = null;
...
//         } catch (Exception e) {}
    ...
    public void pageCreated() {
        ...
        this.facilityInput = new FacilityInput(this);
        this.facilityInput.setFlInput(false);
        this.qinput = new QuoteInput(this);
        this.qinput.clearQuoteInput();
        this.qinput.setQuoteInput(false);
            ...
            if (updateOutput) {
                if (input.isFunctionSet("PAID")) {
                    ...
                    if (trans.getTotalDue().compareTo(BigDecimal.ZERO) > 0) {
                        ...
                        output.print(UtilProperties.getMessage(PosTransaction.resource,"PosBalanceC",defaultLocale) + " " + UtilFormatOut.formatPrice(trans.getTotalDue().negate()));
                    }
                } else {
    ...
    public QuoteInput getQuoteInput () {
    	return this.qinput;
    }
    public FacilityInput getFacilityInput() {
        return this.facilityInput;
    }
